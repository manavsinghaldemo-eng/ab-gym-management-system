    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-16 text-zinc-100">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {plans.map((plan, idx) => (
          ...
          >
            <div
              className={`relative bg-zinc-900 border rounded-2xl p-6 flex flex-col justify-between transition-all hover:scale-[1.02] shadow-xl h-full ${
                plan.popular
            ...
            >
              ...
              <button
                ...
                className={`w-full mt-8 py-3.5 rounded-xl text-xs font-bold tracking-wider uppercase transition-all cursor-pointer ${
                  plan.popular
