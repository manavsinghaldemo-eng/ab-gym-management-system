  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12 text-zinc-100">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <RevealOnScroll direction="left" delayMs={100} className="h-full">
          <div className="bg-zinc-900/90 border border-zinc-800 p-8 rounded-3xl space-y-6 shadow-xl h-full">
        ...
        <RevealOnScroll direction="right" delayMs={150} className="h-full">
          <div className="bg-zinc-900/90 border border-zinc-800 rounded-3xl p-8 flex flex-col justify-between shadow-xl space-y-6 h-full">
            <h3 className="text-xl font-black text-white font-mono uppercase border-b border-zinc-800 pb-3">
              OUR LOCATION
            </h3>
