            ...
            {historyError ? (
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-left font-mono text-xs">
                  <thead>
                    <tr className="border-b border-zinc-800 text-[10px] text-zinc-400 uppercase tracking-wider bg-zinc-950">
                      ...
                      return (
                        <tr key={rec.id || rec.feeReferenceNumber} className="hover:bg-zinc-900/50 transition-colors">
                          ...
                          <td className="py-3 px-3 text-white">
                            <div className="font-bold">{feeMonthDisplay}</div>
                            {rec.selectedPlan && rec.selectedPlan !== feeMonthDisplay && (
                          ...
                          <td className="py-3 px-3 text-right">
                            <div className="flex items-center justify-end gap-1.5">
                              <button
                                ...
                                className="px-2 py-1 bg-emerald-600/20 hover:bg-emerald-600 text-emerald-400 hover:text-white border border-emerald-500/30 rounded-lg text-[10px] font-bold transition-all cursor-pointer inline-flex items-center gap-1"
                              >
                              ...
                              <button
                                ...
                                className="px-2 py-1 bg-blue-600/20 hover:bg-blue-600 text-blue-400 hover:text-white border border-blue-500/30 rounded-lg text-[10px] font-bold transition-all cursor-pointer inline-flex items-center gap-1"
                              >
