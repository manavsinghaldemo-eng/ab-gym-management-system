      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {servicesList.map((srv) => {
          ...
          return (
            <div
              key={srv.id}
              className="bg-zinc-900/80 border border-zinc-800 hover:border-blue-600/50 p-6 rounded-2xl flex flex-col justify-between transition-all group shadow-xl"
            >
              ...
              <div className="mt-6 pt-4 border-t border-zinc-800 flex items-center justify-between text-xs text-zinc-400">
                ...
                <button
                  ...
                  className="px-3.5 py-1.5 rounded-lg bg-blue-950 hover:bg-blue-600 text-blue-400 hover:text-white border border-blue-600/40 font-bold text-xs transition-all flex items-center gap-1"
                >
